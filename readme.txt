...
L’installation se fait en 3 étapes : Ajout / Activation / Configuration

-> Ajout automatique :
1.1 Cliquez  sur ‘Extensions > Ajouter’ dans le menu d’administration de Wordpress
1.2 Indiquez ‘Widget Compostelle Info’ dans le champ de recherche puis cliquez sur le bouton ‘Chercher parmi les extensions’
1.3 Une fois l’extension trouvée, cliquez sur ‘Installer maintenant’
...
Ajout manuel :
Au lieu de l’ajout automatique, vous pouvez remplacer les étapes 1.1 à 1.3 par :
2.1 Téléchargez et décompressez widget-compostelle-info.zip 
2.2 Copiez le répertoire contenant `widget-compostelle-info.php` dans le répertoire `/wp-content/plugins/` 
